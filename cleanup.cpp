...
double MAN(std::array<double, 257>& data, int& NBINS) {
	std::array<double, 257> arr;
	int n = 0;
	...
	std::array<double, 257> non_zero_diff;
	for (int i = 0; i < n; i++) {
...
void threshold(std::array<std::array<double, 257>, 192>& data, int& NBINS, double& threshold) {
...
void find_max(const std::array<std::array<double, 257>, 192>& data, int NBINS, double& maximum) {
	maximum = 0;
...
void same_mode_convolve(std::array<double, 204>& input1, std::array<double, 3>& input2) {
	int size1 = 204;
	int size2 = 3;
	int size_out = size1;
	...
	for (int i = 0; i < size_out; i++) {
		double sum = std::inner_product(input1_padded.begin() + i, input1_padded.begin() + i + size2, reversed_input2.begin(), 0.0);
		input1[i] = sum;
	}
}
...
void sawtooth_filter(std::array<std::array<double, 257>, 192>& data, std::array<std::array<double, 222>, 257>& scratch, std::array<std::array<double, 257>, 192>& output, int& NBINS) {
	...
	std::vector<double> buffer(NBINS * 207, 0.0);
...
// note: always interpolates to between 0 and 1, from a sorted std::array.
inline void linear_size_interpolation(std::array<double, 37>& d) {
	double dx = d[36] - d[0];
	for (int i = 0; i < 37; i++) {
		d[i] = (d[i] - d[0]) / dx;
	}
...
//compiles
double correlationCoefficient(const std::array<double, 257>& X, const std::array<double, 257>& Y, int size) {
...
void fast_entropy(std::array<std::array<double, 257>, 192>& data, std::array<double, 192>& entropy_unmasked, std::array<double, 257>& logit, int NBINS) {
	static std::array<double, 257> d_subset;

	for (int i = 0; i < 192; i++) {
		std::array<double, 257>& d = data[i];
...
double determine_entropy_maximum(const std::array<double, 257>& logit, int NBINS) {
	std::array<double, 257> d = {};
	d[NBINS - 1] = 1.0;
	std::array<double, 257> logit_subset;
...
void fast_peaks(std::array<std::array<double, 257>, 192>& stft_, std::array<int, 192>& entropy, double thresh, std::array<double, 204>& entropy_padded, double& entropy_maximum, int& NBINS, std::array<std::array<double, 257>, 192>& mask) {
...
static int longestConsecutive(std::array<int, 192>& nums, int start, int stop) {
	int curr_streak = 0;
	int max_streak = 0;
	...
	return std::max(max_streak, curr_streak);
}
//compiles
static void remove_outliers(std::array<int, 192>& a, const int& value, const int& threshold, const int& replace) {
	int first = 0;
	int end = 0;
	int index = 0;
	while (first < 192) {
...
//compiles
static void stft(std::array<double, 25087>& xp, const std::array<double, 512>& window, std::array<std::array<std::complex<double>, 257>, 192>& out) {

	static std::array<double, 257> Sx_temp_2;
	static std::array<double, 512> Sx_temp;
...
static void istft(std::array<std::array<std::complex<double>, 257>, 64>& Sx, std::array<double, 384>& buffer, std::array<double, 8192>& output, const std::array<double, 512>& window) {
	static std::array<double, 257> temp;
...
static void generate_true_logistic(std::array<double, 257>& logit, int points) {
	logit.fill(0.0);
	if (points == 1) {
		logit[0] = 1.0;
		return;
...
public:
	...
	std::array<double, 8192> process(std::array<double, 8192> input, double constant = 0.057, int NBINS = 37) {
		...
		if (a.count > 0) {
			...
			if (a.truecount > 22 || longestConsecutive(a.entropy_thresholded, 32, 160) > 16) {
				...
				a.multiplier = std::min(a.multiplier, 1.0);
...
std::array<double, 24576> Filter::Data::audio{};
std::array<double, 25087> Filter::Data::audio_padded{};

std::array<double, 384> Filter::Data::buffer{};
std::array<double, 192> Filter::Data::entropy_unmasked{};
std::array<double, 204> Filter::Data::entropy_padded{};
std::array<double, 257> Filter::Data::logit_distribution{};
std::array<double, 8192> Filter::Data::output{};
std::array<double, 8192> Filter::Data::empty{};
...
std::array<int, 192> Filter::Data::entropy_thresholded{};

bool Filter::Data::set{};

std::array<std::array<double, 222>, 257> Filter::Data::scratch{};
std::array<std::array<std::complex<double>, 257>, 192> Filter::Data::stft_complex{};
std::array<std::array<std::complex<double>, 257>, 64> Filter::Data::stft_output{};
std::array<std::array<std::complex<double>, 257>, 64> Filter::Data::stft_zeros{};
std::array<std::array<double, 257>, 192> Filter::Data::stft_real{};
std::array<std::array<double, 257>, 192> Filter::Data::smoothed{};
std::array<std::array<double, 257>, 192> Filter::Data::previous{};
...
void generate_sine_wave(std::array<double, 8192>& data, double freq, double phase, double amplitude) {
...
void generate_complex_wave(std::array<double, 8192>& data) {
	data.fill(0.0f);
